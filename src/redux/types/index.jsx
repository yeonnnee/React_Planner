...
export const CHECK_USER = "[ACCOUNT] CHECK_USER";
export const CHECK_USER_SUCCESS = "[ACCOUNT] CHECK_USER_SUCCESS";
export const CHECK_USER_FAILED = "[ACCOUNT] CHECK_USER_FAILED";
export const ACCOUNT_ERROR = "[ACCOUNT] ACCOUNT_ERROR";
export const RESET_CHECK_USER_RECORD = "[ACCOUNT] RESET_CHECK_USER_RECORD";
